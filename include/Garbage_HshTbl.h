 ...
 *     PersonTbl_init(&humans, differs, hash, mallocator);
...
static inline int STR_CAT_2_HVyhsPhJ28xdqEfP(NAME, _init)(
	struct NAME*a,
	int(*d)(uintptr_t, void*, void*),
	uint64_t(*h)(uintptr_t cls, void*),
	uintptr_t cls,
	struct Qntan_Mallocator**m
){
	...
	memcpy(a->_opaque + sizeof(uintptr_t)*UNREF_IDX_Ya2N2TBLHPZks5Jc, &opts.unref, sizeof opts.unref);
	return 0;
}
